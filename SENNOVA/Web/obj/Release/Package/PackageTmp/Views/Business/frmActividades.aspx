<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmActividades.aspx.cs" Inherits="Web.Views.Business.frmActividades" %>
    ...
    <div class="container-fluid">
        <asp:UpdatePanel ID="Update" runat="server">
            <ContentTemplate>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="table-responsive-sm">
                                    <asp:GridView ID="grdActividad" runat="server" OnSelectedIndexChanged="grdActividad_SelectedIndexChanged" OnDataBound="grdActividad_DataBound" Height="50px" PageSize="10" AutoGenerateColumns="False" AllowPaging="true" class="table table-bordered table-responsive-sm" HorizontalAlign="Center" Font-Size="XX-Small" EmptyDataText="No hay Activos creados." Width="100%">
                                        <EmptyDataTemplate>
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <asp:LinkButton ID="btnGuardarProducto" Text="Guardar Producto" CssClass="btn btn-outline-success" runat="server" OnClick="btnGuardarProducto_Click" ToolTip="Guardar Producto." />
                                    </div>
                                    <div class="col-md-1">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h3>
                                                <span style="float: right;"><small>Total Registros:</small>
                                                    <asp:Label ID="lblTotalRegistrosProductos" runat="server" CssClass="label label-warning" Text="" />
                                                </span>
                                            </h3>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="table-responsive-sm">
                                                <asp:GridView ID="grdProducto" runat="server" OnSelectedIndexChanged="grdProducto_SelectedIndexChanged" OnDataBound="grdProducto_DataBound" Height="50px" PageSize="10" AutoGenerateColumns="False" AllowPaging="true" class="table table-bordered table-responsive-sm" HorizontalAlign="Center" Font-Size="XX-Small" EmptyDataText="No hay Activos creados." Width="100%">
                                                    <EmptyDataTemplate>
                                                    ...
                                                    <PagerTemplate>
                                                        <div class="row" style="margin-top: 20px;">
                                                            ...
                                                            <div class="col-lg-1" style="text-align: left;">
                                                                <asp:DropDownList ID="PageDropDownList" Width="80px" OnSelectedIndexChanged="PageDropDownListProducto_SelectedIndexChanged" runat="server" AutoPostBack="true" CssClass="form-control" /></h3>
                                                            </div>
                                                            <div class="col-lg-9" style="text-align: right;">
                                                                <h4>
                                                                    <asp:Label ID="CurrentPageLabel" runat="server" CssClass="label label-warning" Text="" /></h4>
                ...
                <!-- Modal Soportes-->
                <div class="modal" id="myModalSoportes" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-xs">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <asp:LinkButton ID="lnkCerrarModalSoportes" Text="Cerrar" CssClass="btn btn-outline-secondary" runat="server" OnClick="lnkCerrarModal_Click" ToolTip="Cerrar Modal." />
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <asp:LinkButton ID="lnkGuardarAvance" Text="Guardar Avance" CssClass="btn btn-outline-success" runat="server" OnClick="lnkGuardarAvance_Click" ToolTip="Guardar Avance." />
                                    </div>
                                </div>
                            </div>
                            <div class="modal-body">
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h3>
                                                <span style="float: right;"><small>Total Registros:</small>
                                                    <asp:Label ID="lblTotalRegistrosAvances" runat="server" CssClass="label label-warning" Text="" />
                                                </span>
                                            </h3>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="table-responsive-sm">
                                                <asp:GridView ID="grdAvance" runat="server" OnSelectedIndexChanged="grdAvance_SelectedIndexChanged" OnDataBound="grdAvance_DataBound" Height="50px" PageSize="10" AutoGenerateColumns="False" AllowPaging="true" class="table table-bordered table-responsive-sm" HorizontalAlign="Center" Font-Size="XX-Small" EmptyDataText="No hay Activos creados." Width="100%">
                                                    <EmptyDataTemplate>
                                                        ¡No hay Avances Asociados!  
                                                    </EmptyDataTemplate>
                                                    <PagerTemplate>
                                                        <div class="row" style="margin-top: 20px;">
                                                            <div class="col-lg-2" style="text-align: right;">
                                                            ...
                                                            <div class="col-lg-1" style="text-align: left;">
                                                                <asp:DropDownList ID="PageDropDownListAvances" Width="80px" OnSelectedIndexChanged="PageDropDownListAvance_SelectedIndexChanged" runat="server" AutoPostBack="true" CssClass="form-control" /></h3>
                                                            </div>
                                                            <div class="col-lg-9" style="text-align: right;">
                                                                <h4>
                                                                    <asp:Label ID="CurrentPageLabel" runat="server" CssClass="label label-warning" Text="" /></h4>
