<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmObjetivosEspecificos.aspx.cs" Inherits="Web.Views.Business.frmObjetivosEspecificos" %>
            ...
            <ContentTemplate>
                <div class="panel ">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-md-6">
                                <h4>Gestionar Objetivos Especificos.</h4>
                            </div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="txtNombre">Objetivo Especifico*</label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="table-responsive-sm">
                                    <asp:GridView ID="grdObjetivoEspecifico" runat="server" OnSelectedIndexChanged="grdObjetivoEspecifico_SelectedIndexChanged" OnDataBound="grdObjetivoEspecifico_DataBound" Height="50px" PageSize="10" AutoGenerateColumns="False" AllowPaging="true" class="table table-bordered table-responsive-sm" HorizontalAlign="Center" Font-Size="XX-Small" EmptyDataText="No hay Activos creados." Width="100%">
                                        <EmptyDataTemplate>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Actividades" ItemStyle-Width="5%" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkActividades" Text="Agregar" CssClass="btn btn-outline-secondary btn-sm" CommandArgument='<%# Eval("Id") %>' runat="server" OnClick="lnkActividades_Click" ToolTip="Gestionar Actividades." ItemStyle-Width="5%" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
