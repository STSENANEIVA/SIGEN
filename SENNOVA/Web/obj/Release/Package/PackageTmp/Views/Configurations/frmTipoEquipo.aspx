<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmTipoEquipo.aspx.cs" Inherits="Web.Views.Configurations.frmTipoEquipo" %>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="table-responsive-sm">
                                    <asp:GridView ID="grdTipoEquipo" runat="server" OnSelectedIndexChanged="grdTipoEquipo_SelectedIndexChanged" OnDataBound="grdTipoEquipo_DataBound" Height="50px" PageSize="10" AutoGenerateColumns="False" AllowPaging="true" class="table table-bordered table-responsive-sm" HorizontalAlign="Center" Font-Size="Small" EmptyDataText="No hay Activos creados." Width="100%">
                                        <EmptyDataTemplate>
