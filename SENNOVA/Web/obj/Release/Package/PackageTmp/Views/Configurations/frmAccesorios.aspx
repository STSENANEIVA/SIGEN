<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmAccesorios.aspx.cs" Inherits="Web.Views.Configurations.frmAccesorios" %>
                                ...
                                <div class="table-responsive-sm">
                                    <asp:GridView ID="grdAccesorios" runat="server" OnSelectedIndexChanged="grdAccesorios_SelectedIndexChanged" OnDataBound="grdAccesorios_DataBound" Height="50px" PageSize="10" AutoGenerateColumns="False" AllowPaging="true" class="table table-bordered table-responsive-sm" HorizontalAlign="Center" Font-Size="Small" EmptyDataText="No hay Activos creados." Width="100%">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="Descripcion" DataField="descripcion" ItemStyle-HorizontalAlign="Center" />
