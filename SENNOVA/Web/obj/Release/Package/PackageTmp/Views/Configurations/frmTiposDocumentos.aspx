<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmTiposDocumentos.aspx.cs" Inherits="Web.Views.Configurations.frmTiposDocumentos" %>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="table-responsive-sm">
                                    <asp:GridView ID="grdTiposDocumentos" runat="server" OnSelectedIndexChanged="grdTiposDocumentos_SelectedIndexChanged" OnDataBound="grdTiposDocumentos_DataBound" Height="50px" PageSize="10" AutoGenerateColumns="False" AllowPaging="true" class="table table-bordered table-responsive-sm" HorizontalAlign="Center" Font-Size="Small" EmptyDataText="No hay Activos creados." Width="100%">
                                        <EmptyDataTemplate>
                                            ¡No hay Tipos de Documentos seleccionados!  
                                        </EmptyDataTemplate>
                                        <PagerTemplate>
