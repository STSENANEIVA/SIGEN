<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmSoftware.aspx.cs" Inherits="Web.Views.Configurations.frmSoftware" %>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="table-responsive-sm">
                                    <asp:GridView ID="grdSoftware" runat="server" OnSelectedIndexChanged="grdSoftware_SelectedIndexChanged" OnDataBound="grdSoftware_DataBound" Height="50px" PageSize="10" AutoGenerateColumns="False" AllowPaging="true" class="table table-bordered table-responsive-sm" HorizontalAlign="Center" Font-Size="Small" EmptyDataText="No hay Activos creados." Width="100%">
                                        <EmptyDataTemplate>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="TipoLicencia " DataField="TipoLicencia.Nombre" ItemStyle-HorizontalAlign="Center" />
