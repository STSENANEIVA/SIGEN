<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmTipoPatron.aspx.cs" Inherits="Web.Views.Configurations.frmTipoPatron" %>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="table-responsive-sm">
                                    <asp:GridView ID="grdTipoPatron" runat="server" OnSelectedIndexChanged="grdTipoPatron_SelectedIndexChanged" OnDataBound="grdTipoPatron_DataBound" Height="50px" PageSize="10" AutoGenerateColumns="False" AllowPaging="true" class="table table-bordered table-responsive-sm" HorizontalAlign="Center" Font-Size="Small" EmptyDataText="No hay Activos creados." Width="100%">
                                        <EmptyDataTemplate>
