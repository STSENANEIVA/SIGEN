<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" ValidateRequest="false" CodeBehind="frmMacroProceso.aspx.cs" Inherits="Web.Views.Configurations.frmMacroProceso" %>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="table-responsive-sm">
                                    <asp:GridView ID="grdMacroProceso" runat="server" OnSelectedIndexChanged="grdMacroProceso_SelectedIndexChanged" OnDataBound="grdMacroProceso_DataBound" Height="50px" PageSize="10" AutoGenerateColumns="False" AllowPaging="true" class="table table-bordered table-responsive-sm" HorizontalAlign="Center" Font-Size="Small" EmptyDataText="No hay Activos creados." Width="100%">
                                        <EmptyDataTemplate>
                                            ¡No hay Macro Procesos seleccionados!  
                                        </EmptyDataTemplate>
                                        <PagerTemplate>
