<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmRegional.aspx.cs" Inherits="Web.Views.Configurations.frmRegional" %>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <asp:TextBox ID="txtIdRegional" runat="server" CssClass="form-control" Visible="false"></asp:TextBox>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="txtRegion">Region</label>
                                    <asp:DropDownList Width="180px" ID="ddlRegion" runat="server" CssClass="form-control" />
                                </div>
                            </div>
                            <div class="col-md-1">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="table-responsive-sm">
                                    <asp:GridView ID="grdRegional" runat="server" OnSelectedIndexChanged="grdRegional_SelectedIndexChanged" OnDataBound="grdRegional_DataBound" Height="50px" PageSize="10" AutoGenerateColumns="False" AllowPaging="true" class="table table-bordered table-responsive-sm" HorizontalAlign="Center" Font-Size="Small" EmptyDataText="No hay Activos creados." Width="100%">
                                        <EmptyDataTemplate>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="Region " DataField="Region.Nombre" ItemStyle-HorizontalAlign="Center" />
