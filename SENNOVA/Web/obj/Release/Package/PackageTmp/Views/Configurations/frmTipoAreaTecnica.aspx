<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmTipoAreaTecnica.aspx.cs" Inherits="Web.Views.Configurations.frmTipoAreaTecnica" %>
            ...
            <asp:UpdatePanel ID="Update" runat="server">
                ...
                <div class="panel ">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-md-6">
                                <h4>Gestionar Tipo de Areas Tecnicas.</h4>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="table-responsive-sm">
                                    <asp:GridView ID="grdTipoAreaTecnica" runat="server" OnSelectedIndexChanged="grdTipoAreaTecnica_SelectedIndexChanged" OnDataBound="grdTipoAreaTecnica_DataBound" Height="50px" PageSize="10" AutoGenerateColumns="False" AllowPaging="true" class="table table-bordered table-responsive-sm" HorizontalAlign="Center" Font-Size="Small" EmptyDataText="No hay Activos creados." Width="100%">
                                        <EmptyDataTemplate>
