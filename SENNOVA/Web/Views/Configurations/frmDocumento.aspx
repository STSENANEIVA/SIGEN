<%@ Page Title="DOCUMENTO" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmDocumento.aspx.cs" Inherits="Web.Views.Configurations.frmDocumento" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid">
        <asp:UpdatePanel ID="Update" runat="server">
                ...
                <div class="panel ">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="upFile">Adjuntar Documento</label>
                        ...
                        <div class="row">
                            <div class="table-responsive">
                                <asp:GridView ID="grdDocumento" runat="server" OnSelectedIndexChanged="grdDocumento_SelectedIndexChanged" AutoGenerateColumns="False" class="table table-bordered table-hover table-striped w-100" EmptyDataText="No hay datos disponibles en la tabla">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Soportes" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkSoportes" Text='<i class="fas fa-file-upload"></i>' CssClass="btn text-success btn-sm" runat="server" CommandArgument='<%# Eval("Id") %>' OnClick="lnkSoportes_Click" ToolTip="Ver soportes" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                    ...
                    <div class="modal-dialog" style="max-width: 650px; margin-top: 10%;">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="table-responsive">
                                    <asp:GridView ID="grdDocumentos" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover table-striped w-100" EmptyDataText="No hay archivos Adjuntados">
                                        <Columns>
            ...
            <Triggers>
                ...
                <asp:PostBackTrigger ControlID="btnCerarModal" />
                <asp:PostBackTrigger ControlID="grdDocumento" />
    ...
    <script type="text/javascript">
        ...
        function confirmAlert(idDocumento) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<%=ResolveUrl("~/Services/SEliminar.asmx/EliminarDocumento") %>',
