<%@ Page Title="SOFTWARE" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmSoftware.aspx.cs" Inherits="Web.Views.Configurations.frmSoftware" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <asp:TextBox ID="txtIdSoftware" runat="server" CssClass="form-control" Visible="false"></asp:TextBox>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList Width="180px" ID="ddlTipoLicencia" runat="server" CssClass="form-control" />
                                </div>
                            </div>
                            <div class="col-md-1">
                                <div class="form-group">
                        ...
                        <div class="container">
                            <div class="table-responsive">
                                <asp:GridView ID="grdSoftware" runat="server" OnSelectedIndexChanged="grdSoftware_SelectedIndexChanged" AutoGenerateColumns="False" class="table table-bordered table-hover table-striped w-100" EmptyDataText="No hay datos disponibles en la tabla">
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Versión " DataField="Version" ItemStyle-HorizontalAlign="Center" />
                                        <asp:BoundField HeaderText="Tipo de Licencia " DataField="TipoLicencia.Nombre" ItemStyle-HorizontalAlign="Center" />
    ...
    <script type="text/javascript">
        ...
        function dataTable() {
            $('#<%=grdSoftware.ClientID%>').DataTable({
                "destroy": true,
                dom: 'lBfrtip',
        ...
        function confirmAlert(idSoftware) {
            Swal.fire({
                title: '¿Estas seguro de eliminar el software?',
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<%=ResolveUrl("~/Services/SEliminar.asmx/EliminarSoftware") %>',
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Oops...',
                            text: 'No se pudo eliminar el software!',
                        })
                    });
                }
            })
