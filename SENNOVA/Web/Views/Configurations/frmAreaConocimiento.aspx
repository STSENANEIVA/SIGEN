<%@ Page Title="AREA DE CONOCIMIENTO" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmAreaConocimiento.aspx.cs" Inherits="Web.Views.Configurations.frmAreaConocimiento" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                        ...
                        <hr />
                            <div class="row">
                                <div class="table-responsive">
                                    <asp:GridView ID="grdAreaConocimiento" runat="server" OnSelectedIndexChanged="grdAreaConocimiento_SelectedIndexChanged" AutoGenerateColumns="False" class="table table-bordered table-hover table-striped w-100" EmptyDataText="No hay datos disponibles en la tabla">
                                        <Columns>
    ...
    <script type="text/javascript">
        ...
        function dataTable() {
            $('#<%=grdAreaConocimiento.ClientID%>').DataTable({
                "destroy": true,
                dom: 'lBfrtip',
                buttons: [
                    'colvis',
