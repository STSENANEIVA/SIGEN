<%@ Page Title="LINEA PROGRAMATICA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmLineaProgramatica.aspx.cs" Inherits="Web.Views.Configurations.frmLineaProgramatica" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                        ...
                        <hr />
                            <div class="row">
                                <div class="table-responsive">
                                    <asp:GridView ID="grdLineaProgramatica" runat="server" OnSelectedIndexChanged="grdLineaProgramatica_SelectedIndexChanged"  AutoGenerateColumns="False"  class="table table-bordered table-hover table-striped w-100"  EmptyDataText="No hay datos disponibles en la tabla">
                                        <Columns>
    ...
    <script type="text/javascript">
        ...
        function dataTable() {
            $('#<%=grdLineaProgramatica.ClientID%>').DataTable({
                "destroy": true,
                dom: 'lBfrtip',
                buttons: [
                    'colvis',
