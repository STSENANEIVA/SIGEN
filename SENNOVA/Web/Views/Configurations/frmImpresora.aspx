<%@ Page Title="IMPRESORA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmImpresora.aspx.cs" Inherits="Web.Views.Configurations.frmImpresora" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <asp:TextBox ID="txtIdImpresora" runat="server" CssClass="form-control" Visible="false"></asp:TextBox>
                            </div>
                            <div class="col-md-1">
                                <div class="form-group">
                        ...
                        <div class="container">
                            <div class="table-responsive">
                                <asp:GridView ID="grdImpresora" runat="server" OnSelectedIndexChanged="grdImpresora_SelectedIndexChanged" AutoGenerateColumns="False" class="table table-bordered table-hover table-striped w-100" EmptyDataText="No hay datos disponibles en la tabla">
                                    <Columns>
    ...
    <script type="text/javascript">
        ...
        function dataTable() {
            $('#<%=grdImpresora.ClientID%>').DataTable({
                "destroy": true,
                dom: 'lBfrtip',
        ...
        function confirmAlert(idImpresora) {
            Swal.fire({
                title: '¿Estas seguro de eliminar la impresora?',
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<%=ResolveUrl("~/Services/SEliminar.asmx/EliminarImpresora") %>',
