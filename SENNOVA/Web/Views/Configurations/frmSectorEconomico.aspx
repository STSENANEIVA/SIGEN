<%@ Page Title="SECTOR ECONÓMICO" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmSectorEconomico.aspx.cs" Inherits="Web.Views.Configurations.frmSectorEconomico" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <asp:UpdatePanel ID="Update" runat="server">
                ...
                <div class="panel ">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-md-6">
                                <h4>Gestionar Sectores Económicos.</h4>
                            </div>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <asp:TextBox ID="txtIdSectorEconomico" runat="server" CssClass="form-control" Visible="false"></asp:TextBox>
                            </div>
                            <div class="col-md-1">
                                <div class="form-group">
                        ...
                        <hr />
                            <div class="container">
                                <div class="table-responsive">
                                    <asp:GridView ID="grdSectorEconomico" runat="server" OnSelectedIndexChanged="grdSectorEconomico_SelectedIndexChanged" AutoGenerateColumns="False" class="table table-bordered table-hover table-striped w-100" EmptyDataText="No hay datos disponibles en la tabla">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText='<i class="fas fa-trash-alt"></i>' ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkEliminar" Text='<i class="fas fa-trash-alt"></i>' CssClass="btn text-danger btn-sm" CommandArgument='<%# Eval("Id") %>' runat="server" OnClick="lnkEliminar_Click" ToolTip="Eliminar Costo." />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
    ...
    <script type="text/javascript">
        ...
        function dataTable() {
            $('#<%=grdSectorEconomico.ClientID%>').DataTable({
                "destroy": true,
                dom: 'lBfrtip',
        ...
        function confirmAlert(idSectorEconomico) {
            Swal.fire({
                title: '¿Estas seguro de eliminar el sector económico?',
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<%=ResolveUrl("~/Services/SEliminar.asmx/EliminarSectorEconomico") %>',
                        data: "{ 'idSectorEconomico': '" + idSectorEconomico + "'}",
                    dataType: "json",
                    type: "POST",
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Oops...',
                        text: 'No se pudo eliminar el sector economico!',
                    })
                });
            }
        })
