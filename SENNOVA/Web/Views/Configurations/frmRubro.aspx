<%@ Page Title="RUBRO" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmRubro.aspx.cs" Inherits="Web.Views.Configurations.frmRubro" %>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <asp:TextBox ID="txtIdRubro" runat="server" CssClass="form-control" Visible="false"></asp:TextBox>
                            </div>
                            <div class="col-md-1">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="table-responsive">
                                <asp:GridView ID="grdRubro" runat="server" OnSelectedIndexChanged="grdRubro_SelectedIndexChanged" AutoGenerateColumns="False" class="table table-bordered table-hover table-striped w-100" EmptyDataText="No hay datos disponibles en la tabla.">
                                    <Columns>
        ...
        function confirmAlert(idRubro) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<%=ResolveUrl("~/Services/SEliminar.asmx/EliminarRubro") %>',
