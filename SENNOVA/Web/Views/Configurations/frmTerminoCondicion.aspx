<%@ Page Title="TERMINOS Y CONDICIONES" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmTerminoCondicion.aspx.cs" Inherits="Web.Views.Configurations.frmTerminoCondicion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <ContentTemplate>
                <div class="panel ">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-md-6">
                                <h4>Gestionar Terminos y Condiciones.</h4>
                            </div>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox TextMode="MultiLine" Rows="3" ID="txtNombre" runat="server" class="form-control"></asp:TextBox>
                                </div>
                                <asp:TextBox ID="txtIdTerminoCondicion" runat="server" CssClass="form-control" Visible="false"></asp:TextBox>
                            </div>
                            <div class="col-md-1">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="table-responsive">
                                <asp:GridView ID="grdTerminoCondicion" runat="server" OnSelectedIndexChanged="grdTerminoCondicion_SelectedIndexChanged" AutoGenerateColumns="False" class="table table-bordered table-hover table-striped w-100" EmptyDataText="No hay datos disponibles en la tabla">
                                    <Columns>
    ...
    <script type="text/javascript">
        ...
        function dataTable() {
            $('#<%=grdTerminoCondicion.ClientID%>').DataTable({
                "destroy": true,
                dom: 'lBfrtip',
        ...
        function confirmAlert(idTerminoCondicion) {
            Swal.fire({
                title: '¿Estas seguro de eliminar el Termino y Condición?',
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<%=ResolveUrl("~/Services/SEliminar.asmx/EliminarTerminoCondicion") %>',
                        data: "{ 'idTerminoCondicion': '" + idTerminoCondicion + "'}",
                        dataType: "json",
                        type: "POST",
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Oops...',
                            text: 'No se pudo eliminar el Termino y Condición!',
                        })
                    });
                }
            })
