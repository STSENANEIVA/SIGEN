<%@ Page Title="REGIÓN" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmRegion.aspx.cs" Inherits="Web.Views.Configurations.frmRegion" %>
                        ...
                        <hr />
                            <div class="row">
                                <div class="table-responsive">
                                    <asp:GridView ID="grdRegion" runat="server" OnSelectedIndexChanged="grdRegion_SelectedIndexChanged"  AutoGenerateColumns="False"  class="table table-bordered table-hover table-striped w-100"  EmptyDataText="No hay datos disponibles en la tabla">
                                        <Columns>
