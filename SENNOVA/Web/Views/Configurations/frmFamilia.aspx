<%@ Page Title="FAMILIA DE SERVICIOS" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmFamilia.aspx.cs" Inherits="Web.Views.Configurations.frmFamilia" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <ContentTemplate>
                <div class="panel ">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <asp:TextBox Id="txtIdFamilia" runat="server" CssClass="form-control" Visible="false"></asp:TextBox>
                            <div class="col-md-2">
                        ...
                        <div class="row">
                            <div class="table-responsive">
                                <asp:GridView ID="grdFamilia" runat="server" OnSelectedIndexChanged="grdFamilia_SelectedIndexChanged" AutoGenerateColumns="False" class="table table-bordered table-hover table-striped w-100" EmptyDataText="No hay datos disponibles en la tabla">
                                      <Columns>
    ...
    <script type="text/javascript">
        ...
        function confirmAlert(idFamilia) {
            Swal.fire({
                title: '¿Estas seguro de eliminar la familia de servicio?',
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<%=ResolveUrl("~/Services/SEliminar.asmx/EliminarFamiliaServicio") %>',
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Oops...',
                            text: 'No se pudo eliminar la familia de servicio!',
                        })
                    });
                }
            })
