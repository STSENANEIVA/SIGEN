<%@ Page Title="TIPO DOCUMENTO" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmTiposDocumentos.aspx.cs" Inherits="Web.Views.Configurations.frmTiposDocumentos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <ContentTemplate>
                <div class="panel ">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-md-6">
                                <h4>Gestionar Tipos de Documentos.</h4>
                            </div>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <asp:TextBox ID="txtIdTiposDocumentos" runat="server" CssClass="form-control" Visible="false"></asp:TextBox>
                            </div>
                            <div class="col-md-1">
                                <div class="form-group">
                        ...
                        <div class="container">
                            <div class="table-responsive">
                                <asp:GridView ID="grdTiposDocumentos" runat="server" OnSelectedIndexChanged="grdTiposDocumentos_SelectedIndexChanged" AutoGenerateColumns="False" class="table table-bordered table-hover table-striped w-100" EmptyDataText="No hay datos disponibles en la tabla">
                                    <Columns>
    ...
    <script type="text/javascript">
        ...
        function dataTable() {
            $('#<%=grdTiposDocumentos.ClientID%>').DataTable({
                "destroy": true,
                dom: 'lBfrtip',
        ...
        function confirmAlert(idTiposDocumentos) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<%=ResolveUrl("~/Services/SEliminar.asmx/EliminarTiposDocumentos") %>',
                        data: "{ 'idTiposDocumentos': '" + idTiposDocumentos + "'}",
                        dataType: "json",
                        type: "POST",
