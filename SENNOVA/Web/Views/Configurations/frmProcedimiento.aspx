<%@ Page Title="PROCEDIMIENTO" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmProcedimiento.aspx.cs" Inherits="Web.Views.Configurations.frmProcedimiento" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <ContentTemplate>
                <div class="panel ">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-md-6">
                                <h4>Gestionar Procedimientos.</h4>
                            </div>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <asp:TextBox ID="txtIdProcedimiento" runat="server" CssClass="form-control" Visible="false"></asp:TextBox>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="txtProceso">Proceso</label>
                                    <asp:DropDownList Width="180px" ID="ddlProceso" runat="server" CssClass="form-control" />
                                </div>
                            </div>
                            <div class="col-md-1">
                                <div class="form-group">
                        ...
                        <div class="container">
                            <div class="table-responsive">
                                <asp:GridView ID="grdProcedimiento" runat="server" OnSelectedIndexChanged="grdProcedimiento_SelectedIndexChanged" AutoGenerateColumns="False" class="table table-bordered table-hover table-striped w-100" EmptyDataText="No hay datos disponibles en la tabla">
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Proceso " DataField="Proceso.Nombre" ItemStyle-HorizontalAlign="Center" />
    ...
    <script type="text/javascript">
        ...
        function dataTable() {
            $('#<%=grdProcedimiento.ClientID%>').DataTable({
                "destroy": true,
                dom: 'lBfrtip',
        ...
        function confirmAlert(idProcedimiento) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<%=ResolveUrl("~/Services/SEliminar.asmx/EliminarProcedimiento") %>',
