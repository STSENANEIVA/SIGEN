<%@ Page Title="ROL" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmRolSennova.aspx.cs" Inherits="Web.Views.Configurations.frmRolSennova" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:TextBox ID="txtIdRolSennova" runat="server" CssClass="form-control" Visible="false"></asp:TextBox>
                            </div>
                            <div class="col-md-1">
                                <div class="form-group">
                        ...
                        <div class="container">
                            <div class="table-responsive">
                                <asp:GridView ID="grdRolSennova" runat="server" OnSelectedIndexChanged="grdRolSennova_SelectedIndexChanged" AutoGenerateColumns="False" class="table table-bordered table-hover table-striped w-100" EmptyDataText="No hay datos disponibles en la tabla">
                                    <Columns>
    ...
    <script type="text/javascript">
        ...
        function dataTable() {
            $('#<%=grdRolSennova.ClientID%>').DataTable({
                "destroy": true,
                dom: 'lBfrtip',
        ...
        function confirmAlert(idRolSennova) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<%=ResolveUrl("~/Services/SEliminar.asmx/EliminarRolSennova") %>',
                        data: "{ 'idRolSennova': '" + idRolSennova + "'}",
                        dataType: "json",
                        type: "POST",
