<%@ Page Title="RED DE CONOCIMIENTO SECTORIAL" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmRedConocimientoSectorial.aspx.cs" Inherits="Web.Views.Configurations.frmRedConocimientoSectorial" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                        ...
                        <hr />
                            <div class="row">
                                <div class="table-responsive">
                                    <asp:GridView ID="grdRedConocimientoSectorial" runat="server" OnSelectedIndexChanged="grdRedConocimientoSectorial_SelectedIndexChanged" AutoGenerateColumns="False"  class="table table-bordered table-hover table-striped w-100"  EmptyDataText="No hay datos disponibles en la tabla">
                                        <Columns>
    ...
    <script type="text/javascript">
        ...
        function dataTable() {
            $('#<%=grdRedConocimientoSectorial.ClientID%>').DataTable({
                "destroy": true,
                dom: 'lBfrtip',
                buttons: [
                    'colvis',
