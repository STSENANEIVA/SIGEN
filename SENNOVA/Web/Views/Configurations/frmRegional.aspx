<%@ Page Title="REGIONAL" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmRegional.aspx.cs" Inherits="Web.Views.Configurations.frmRegional" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                        ...
                        <hr />
                            <div class="row">
                                <div class="table-responsive">
                                    <asp:GridView ID="grdRegional" runat="server" OnSelectedIndexChanged="grdRegional_SelectedIndexChanged" AutoGenerateColumns="False" class="table table-bordered table-hover table-striped w-100" EmptyDataText="No hay datos disponibles en la tabla">
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="Región " DataField="Region.Nombre" ItemStyle-HorizontalAlign="Center" />
    ...
    <script type="text/javascript">
        ...
        function dataTable() {
            $('#<%=grdRegional.ClientID%>').DataTable({
                "destroy": true,
                dom: 'lBfrtip',
                buttons: [
                    'colvis',
