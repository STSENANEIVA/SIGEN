<%@ Page Title="MACRO PROCESOS" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" ValidateRequest="false" CodeBehind="frmMacroProceso.aspx.cs" Inherits="Web.Views.Configurations.frmMacroProceso" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <ContentTemplate>
                <div class="panel ">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-md-6">
                                <h4>Gestionar Macro Procesos.</h4>
                            </div>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <asp:TextBox ID="txtIdMacroProceso" runat="server" CssClass="form-control" Visible="false"></asp:TextBox>
                            </div>

                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="txtColor">Color *</label>
                                    <asp:TextBox ID="txtColor" runat="server" TextMode="Color" class="form-control"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-1">
                                <div class="form-group">
                        ...
                        <div class="row">--%>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtIcono" TextMode="MultiLine" Rows="3" runat="server" class="form-control"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <hr />
                        <div class="container">
                            <div class="table-responsive">
                                <asp:GridView ID="grdMacroProceso" runat="server" OnSelectedIndexChanged="grdMacroProceso_SelectedIndexChanged" AutoGenerateColumns="False" class="table table-bordered table-hover table-striped w-100" EmptyDataText="No hay datos disponibles en la tabla">
                                    <Columns>
    ...
    <script type="text/javascript">
        ...
        function dataTable() {
            $('#<%=grdMacroProceso.ClientID%>').DataTable({
                "destroy": true,
                dom: 'lBfrtip',
        ...
        function confirmAlert(idMacroProceso) {
            Swal.fire({
                title: '¿Estas seguro de eliminar el Macro Proceso?',
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<%=ResolveUrl("~/Services/SEliminar.asmx/EliminarMacroProceso") %>',
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Oops...',
                            text: 'No se pudo eliminar el Macro Proceso!',
                        })
                    });
                }
            })
