<%@ Page Title="PROCESO" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmProceso.aspx.cs" Inherits="Web.Views.Configurations.frmProceso" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <asp:TextBox ID="txtIdProceso" runat="server" CssClass="form-control" Visible="false"></asp:TextBox>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="txtMacroProceso">Macro Proceso</label>
                                    <asp:DropDownList Width="180px" ID="ddlMacroProceso" runat="server" CssClass="form-control" />
                                </div>
                            </div>
                            <div class="col-md-1">
                                <div class="form-group">
                        ...
                        <div class="container">
                            <div class="table-responsive">
                                <asp:GridView ID="grdProceso" runat="server" OnSelectedIndexChanged="grdProceso_SelectedIndexChanged" AutoGenerateColumns="False" class="table table-bordered table-hover table-striped w-100" EmptyDataText="No hay datos disponibles en la tabla">
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Macro Proceso " DataField="MacroProceso.Nombre" ItemStyle-HorizontalAlign="Center" />
    ...
    <script type="text/javascript">
        ...
        function confirmAlert(idProceso) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<%=ResolveUrl("~/Services/SEliminar.asmx/EliminarProceso") %>',
