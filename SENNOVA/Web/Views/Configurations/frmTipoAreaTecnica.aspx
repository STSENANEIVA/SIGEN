<%@ Page Title="TIPO ÁREA TÉCNICA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmTipoAreaTecnica.aspx.cs" Inherits="Web.Views.Configurations.frmTipoAreaTecnica" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <asp:UpdatePanel ID="Update" runat="server">
                ...
                <div class="panel ">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-md-6">
                                <h4>Gestionar Tipo de Áreas Técnicas.</h4>
                            </div>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <asp:TextBox ID="txtIdTipoAreaTecnica" runat="server" CssClass="form-control" Visible="false"></asp:TextBox>
                            </div>
                            <div class="col-md-1">
                                <div class="form-group">
                        ...
                        <hr />
                            <div class="container">
                                <div class="table-responsive">
                                    <asp:GridView ID="grdTipoAreaTecnica" runat="server" OnSelectedIndexChanged="grdTipoAreaTecnica_SelectedIndexChanged" AutoGenerateColumns="False" class="table table-bordered table-hover table-striped w-100" EmptyDataText="No hay datos disponibles en la tabla">
                                        <Columns>
    ...
    <script type="text/javascript">
        ...
        function dataTable() {
            $('#<%=grdTipoAreaTecnica.ClientID%>').DataTable({
                "destroy": true,
                dom: 'lBfrtip',
        ...
        function confirmAlert(idTipoAreaTecnica) {
            Swal.fire({
                title: '¿Estas seguro de eliminar el tipo de área técnica?',
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<%=ResolveUrl("~/Services/SEliminar.asmx/EliminarTipoAreaTecnica") %>',
                        data: "{ 'idTipoAreaTecnica': '" + idTipoAreaTecnica + "'}",
                    dataType: "json",
                    type: "POST",
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Oops...',
                        text: 'No se pudo eliminar el tipo de área técnica!',
                    })
                });
            }
        })
