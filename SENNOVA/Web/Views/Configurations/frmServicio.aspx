<%@ Page Title="SERVICIOS" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmServicio.aspx.cs" Inherits="Web.Views.Configurations.frmServicio" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <ContentTemplate>
                <div class="panel ">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <asp:TextBox ID="txtIdServicio" runat="server" CssClass="form-control" Visible="false"></asp:TextBox>
                            ...
                            <div class="col-2">
                                ...
                                <asp:DropDownList Width="180px" ID="ddlAreaTecnica" runat="server" CssClass="form-control" />
                            </div>

                            <div class="col-2">
                                <label for="txtPrecio">Precio *</label>
                                <asp:TextBox ID="txtPrecio" TextMode="Number" runat="server" class="form-control"></asp:TextBox>
                            </div>

                            <div class="col-2">
                                <label for="ddlFamilia">Familia</label>
                                <asp:DropDownList Width="180px" ID="ddlFamilia" runat="server" CssClass="form-control" />
                            </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <asp:TextBox ID="txtRequisitos" TextMode="MultiLine" Rows="3" runat="server" class="form-control"></asp:TextBox>
                            </div>

                            <div class="col-6">
                                <label for="txtAlcance">Alcance *</label>
                                <asp:TextBox ID="txtAlcance" TextMode="MultiLine" Rows="3" runat="server" class="form-control"></asp:TextBox>
                            </div>
                        </div>
                        <hr /><br />
                            <div class="container">
                                <div class="table-responsive">
                                    <asp:GridView ID="grdServicio" runat="server" OnSelectedIndexChanged="grdServicio_SelectedIndexChanged" AutoGenerateColumns="False"  class="table table-bordered table-hover table-striped w-100" EmptyDataText="No hay datos disponibles en la tabla">
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="Área Técnica" DataField="AreaTecnica.NombreSin" ItemStyle-HorizontalAlign="Center" />
                                            <asp:BoundField HeaderText="Alcance" DataField="Alcance" ItemStyle-HorizontalAlign="Center" />
                                            <asp:BoundField HeaderText="Requisitos" DataField="Requisitos" ItemStyle-HorizontalAlign="Center" />
                                            <asp:BoundField HeaderText="Familia" DataField="Familia.Nombre" ItemStyle-HorizontalAlign="Center" />
                                            <asp:BoundField HeaderText="Precio" DataField="Valor" ItemStyle-HorizontalAlign="Center" />
    ...
    <script type="text/javascript">
        ...
        function dataTable() {
            $('#<%=grdServicio.ClientID%>').DataTable({
                "destroy": true,
                dom: 'lBfrtip',
        ...
        function confirmAlert(idServicio) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<%=ResolveUrl("~/Services/SEliminar.asmx/EliminarServicio") %>',
