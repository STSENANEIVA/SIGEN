<%@ Page Title="TIPO DE PRODUCTO" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmTipoProducto.aspx.cs" Inherits="Web.Views.Configurations.frmTipoProducto" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                        ...
                        <hr />
                            <div class="row">
                                <div class="table-responsive-sm">
                                    <asp:GridView ID="grdTipoProducto" runat="server" OnSelectedIndexChanged="grdTipoProducto_SelectedIndexChanged"  AutoGenerateColumns="False" class="table table-bordered table-hover table-striped w-100"  EmptyDataText="No hay datos disponibles en la tabla" >
                                        <Columns>
    ...
    <script type="text/javascript">
        ...
        function dataTable() {
            $('#<%=grdTipoProducto.ClientID%>').DataTable({
                "destroy": true,
                dom: 'lBfrtip',
                buttons: [
                    'colvis',
