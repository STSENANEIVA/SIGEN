...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluid">
        <asp:UpdatePanel ID="Update" runat="server">
            <ContentTemplate>
                <div class="panel ">
                    ...
                    <div class="panel-body">
                        ...
                        <hr />
                        <asp:TextBox ID="txtIdEquipoTecnico" runat="server" class="form-control" Visible="false"></asp:TextBox>
                        <div class="row">
                            <div class="col-md-2">
                        ...
                        <div class="row">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <div class="col-md-2">
                                    <div class="btn-group pull-right">
                                        <asp:LinkButton ID="btnGuardarSoftware" runat="server" OnClick="btnGuardarSoftware_Click" class="btn btn-outline-secondary btn-lg">Guardar</asp:LinkButton>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="table-responsive-sm">
                                <asp:GridView ID="grdSoftware" runat="server" AutoGenerateColumns="False" class="table table-bordered table-hover table-striped w-100" EmptyDataText="No hay datos disponibles en la tabla">
                                    <Columns>
                                        <asp:BoundField HeaderText="Id" DataField="Id" ItemStyle-CssClass="hide" HeaderStyle-CssClass="hide" />
                        ...
                        <h4>
                            ...
                            <h5><label>Extenciones permitidas (.xlsx, .pdf, .docx)</label></h5>
                        <hr />
                        <div class="row">
                        ...
                        <h4>
                            ...
                            <h5><label>Extenciones permitidas (.png, .jpeg, .jpg)</label></h5>
                        <hr />
                        <div class="row">
                            <div class="btn-group col-md-4">
            ...
            <Triggers>
                <asp:PostBackTrigger ControlID="btnAgregarAccesorios" />
                <asp:PostBackTrigger ControlID="btnAgregarSoftware" />
